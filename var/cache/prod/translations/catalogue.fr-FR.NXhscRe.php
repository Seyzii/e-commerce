...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Layout Mod' => 'Layout Mod',
    'Float Header' => 'Float Header',
    'Live Theme Editor' => 'Live Theme Editor',
    'Those Images in folder YOURTHEME/assets/img/patterns/' => 'Those Images in folder YOURTHEME/assets/img/patterns/',
    ...
    'November' => 'November',
    'December' => 'December',
    'No slide at this time.' => 'No slide at this time.',
    '%s' => '%s',
    'Hurry up ! Time left:' => 'Hurry up ! Time left:',
    ...
    'Sorry, We are updating data, please come back later!!!!' => 'Sorry, We are updating data, please come back later!!!!',
    'Childrens' => 'Childrens',
    ...
    'Hit' => 'Hit',
    'Tags:' => 'Tags:',
    'In Same Category' => 'In Same Category',
    'Related by Tags' => 'Related by Tags',
    'Sorry, This blog is not avariable. May be this was unpublished or deleted.' => 'Sorry, This blog is not avariable. May be this was unpublished or deleted.',
    'Filter Blogs By Tag' => 'Filter Blogs By Tag',
    'Filter Blogs By Blogger' => 'Filter Blogs By Blogger',
    'Lastest Blogs' => 'Lastest Blogs',
    'RSS' => 'RSS',
    'Sorry, We are update data, please come back later!!!!' => 'Sorry, We are update data, please come back later!!!!',
    ...
    'Showing %start% - %showing% of %total% items' => 'Showing %start% - %showing% of %total% items',
    'Showing %start% - %showing% of 1 item' => 'Showing %start% - %showing% of 1 item',
    ...
    'Search for products you are interested' => 'Search for products you are interested',
    'Best Sellers' => 'Best Sellers',
    'View All' => 'View All',
    'On sale' => 'On sale',
    'All brands' => 'All brands',
    'Related products' => 'Related products',
    'There is %s other product in the same category' => 'There is %s other product in the same category',
    'There are %s other products in the same category' => 'There are %s other products in the same category',
    'Call us:' => 'Call us:',
    'Fax:' => 'Fax:',
    'Email us:' => 'Email us:',
    'About us' => 'About us',
    ...
    'Sorry for the inconvenience, but the Web address you\'ve entered is no longer available.' => 'Sorry for the inconvenience, but the Web address you\'ve entered is no longer available.',
...
Dès que vous cliquez sur "Adapter en RTL", n\'importe quel fichier spécifique au RTL que vous auriez ajouté à votre thème pourrait être supprimé par la feuille de style créée.',
  ...
  array (
    ...
    'Pages' => 'Pages',
    'Add new theme' => 'Importer un thème',
  ...
  array (
    ...
    'Currency:' => 'Devise:',
    'Currency dropdown' => 'menu déroulant des devises',
    'Get our latest news and special sales' => 'Recevez nos offres spéciales',
    'Carousel buttons' => 'boutons carrousel',
    'Previous' => 'précédent',
    'Next' => 'Prochain',
    'Language:' => 'La langue:',
    'Language dropdown' => 'menu déroulant Langue',
    ...
    'List of sub categories in %name%:' => 'Liste de sous-catégories dans %name% :',
    'Sitemap' => 'Plan du site',
    'Our stores' => 'Nos magasins',
    'About and Contact' => 'A propos et Contact',
    'Home' => 'Accueil',
    'Date' => 'date',
    'Status' => 'statut',
    'We\'ll be back soon.' => 'Nous reviendrons bientôt.',
    'Sorry for the inconvenience.' => 'Désolé pour le désagrément.',
    'Search again what you are looking for' => 'Recherche supplémentaire ce que vous cherchez',
    '403 Forbidden' => '403 Forbidden',
    'You cannot access this store from your country. We apologize for the inconvenience.' => 'Vous ne pouvez pas accéder à ce magasin de votre pays. Nous nous excusons pour le désagrément.',
    'Panel Tool' => 'Outil Panel',
    'Layout Mod' => 'Mise en page Mod',
    'Float Header' => 'Float Header',
    'Live Theme Editor' => 'Editeur de thèmes en direct',
    'Those Images in folder YOURTHEME/assets/img/patterns/' => 'Ces images dans le dossier votretheme / assets / img / modèles /',
    ...
    'Created On' => 'Créé sur',
    'Comment Link' => 'Lien vers le commentaire',
    'Leave your comment' => 'laisse ton commentaire',
    'Captcha' => 'Captcha',
    'Hits' => 'Les coups',
    'st' => 'st',
    'nd' => 'Dakota du Nord',
    ...
    'November' => 'novembre',
    'December' => 'décembre',
    'No slide at this time.' => 'Aucune diapositive à ce moment.',
    '%s' => '%s',
    'Hurry up ! Time left:' => 'Dépêchez-vous ! Temps restant:',
    'Visit Shop' => 'Visitez la boutique',
    'See All' => 'Voir tout',
    'Previous Deal' => 'Traiter précédente',
    'Next Deal' => 'Suivant Traiter',
    'Setting' => 'Réglage',
    'Language' => 'La langue',
    'Currency' => 'Devise',
    'Hello' => 'Bonjour',
    ...
    'Wishlist' => 'liste',
    'Compare' => 'Compare',
    'Sorry, We are updating data, please come back later!!!!' => 'données Désolé, nous mettons à jour, s\'il vous plaît revenir plus tard !!!!',
    'Childrens' => 'enfants',
    'Recent blog posts' => 'Derniers messages du blog',
    'In' => 'Dans',
    'On' => 'Sur',
    'Hit' => 'Frappé',
    'Tags:' => 'Mots clés:',
    'In Same Category' => 'Dans la même catégorie',
    'Related by Tags' => 'Rapporté par mots clés',
    'Sorry, This blog is not avariable. May be this was unpublished or deleted.' => 'Désolé, Ce blog est pas avariable. Peut-être cela était inédit ou supprimé.',
    'Filter Blogs By Tag' => 'Filtrer par Balise Blogs',
    'Filter Blogs By Blogger' => 'Filtrer les blogs Par Blogger',
    ...
    'Please enable JavaScript to view the.' => 'S\'il vous plaît activer JavaScript pour afficher les.',
    'Comments powered by Disqus.' => 'Commentaires gérés par Disqus.',
    'Showing %start% - %showing% of %total% items' => 'Liste %start% - %showing% de %total% point',
    'Showing %start% - %showing% of 1 item' => 'Liste %start% - %showing% de 1 point',
    'Like This' => 'Comme ça',
    'Twitter' => 'Gazouillement',
    'Blog Categories' => 'blog Catégories',
    'No RSS feed added' => 'Aucun flux RSS ajouté',
    'Add to cart' => 'Panier',
    'Search product' => 'Recherche produit',
    'Search for products you are interested' => 'Recherche de produits qui vous intéresse',
    'Best Sellers' => 'Meilleures ventes',
    'View All' => 'Voir tout',
    'On sale' => 'En soldes',
    'All brands' => 'Toutes les marques',
    'Related products' => 'Produits apparentés',
    'There is %s other product in the same category' => 'Il existe %s d\'autres produits dans la même catégorie',
    'There are %s other products in the same category' => 'Il y a %s d\'autres produits dans la même catégorie',
    'About us' => 'À propos de nous',
    '[1]%phone%[/1]' => '[1]%phone%[/1]',
    '[1]%fax%[/1]' => '[1]%fax%[/1]',
    '[1]%email%[/1]' => '[1]%email%[/1]',
    'Your account' => 'Votre compte',
    'Join Our Newsletter' => 'Joignez-vous à notre newsletter',
    'Newsletter' => 'Bulletin',
    ...
    'item' => 'item',
    'empty' => 'vide',
    'Viewed products' => 'Produits consultés',
    'Grid' => 'la grille',
    'List' => 'liste',
    'edit' => 'modifier',
    'List of pages in %name%:' => 'Liste des pages en %name% :',
    'Sorry for the inconvenience, but the Web address you\'ve entered is no longer available.' => 'Sorry for the inconvenience, but the Web address you\'ve entered is no longer available.',
    'Back to home' => 'Back to home',
    'Theme' => 'Thème',
    'Default' => 'Défaut',
    'Quick view' => 'Aperçu rapide',
    'No blog at this time.' => 'Pas de blog à ce moment.',
    'No products at this time.' => 'Aucun produit à l\'heure actuelle.',
    'Loading...' => 'Chargement...',
    'Show more' => 'Montre plus',
    'Other views' => 'Autres vues',
    'Send' => 'Envoyer',
    'Brands' => 'Marques',
    'No brand' => 'Sans marque',
    'Skilled is also likely to be focused on fast and bright teaching, it\'s a great type of courses to...' => 'Qualifiés est également susceptible de se concentrer sur l\'enseignement rapide et lumineux, il est un grand type de cours à ...',
    'Get Newsletter' => 'Obtenez Bulletin',
    'Subscribe' => 'Souscrire',
    'OK' => 'D\'accord',
    'All new products' => 'Tous les nouveaux produits',
    'Follow us' => 'Suivez-nous',
    'All sale products' => 'Tous les produits de la vente',
    ...
    'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%b")' => 'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%b")',
    ...
    '%s other product in the same category' => '%s autres produits dans la même catégorie',
    '%s other products in the same category' => '%s autres produits dans la même catégorie',
    ' items' => ' articles',
    'Discover Now' => 'Découvrez maintenant',
    'Discover All' => 'Découvrez tous',
    ...
    'Prev' => 'Précédent',
    'Minutes' => 'Minutes',
    'If your question is not answered there, please use one of the contact methods below.' => 'Si votre question ne répond pas là, s\'il vous plaît utiliser l\'une des méthodes de contact ci-dessous.',
    'Go' => 'Aller',
  ...
  array (
    ...
    'Not you? [1]Log out[/1]' => 'Pas toi? [1]Log out[/1]',
    'Connected as [1]%firstname% %lastname%[/1].' => 'Connecté comme [1]%firstname% %lastname%[/1].',
    'Back to your account' => 'retour à votre compte',
    'Merchandise return' => 'Retour de marchandise',
    'If you wish to return one or more products, please mark the corresponding boxes and provide an explanation for the return. When complete, click the button below.' => 'Si vous souhaitez retourner un ou plusieurs produits, s\'il vous plaît cocher les cases correspondantes et fournir une explication pour le retour. Lorsque vous avez terminé, cliquez sur le bouton ci-dessous.',
    'Request a return' => 'Demander un retour',
    'Returned' => 'Revenu',
    'Messages' => 'Messages',
    'Add a message' => 'Ajouter un message',
    'If you would like to add a comment about your order, please write it in the field below.' => 'Si vous souhaitez ajouter un commentaire au sujet de votre commande, s\'il vous plaît écrivez-le dans le champ ci-dessous.',
    'Update your address' => 'Mettez à jour votre adresse',
    'New address' => 'Nouvelle adresse',
    'Your addresses' => 'vos adresses',
    'Log in to your account' => 'Connectez-vous à votre compte',
    'No account? Create one here' => 'Pas de compte? Créer un ici',
    'Your vouchers' => 'vos bons',
    'Guest Order Tracking' => 'Invité Suivi de commande',
    'To track your order, please enter the following information:' => 'Pour suivre votre commande, s\'il vous plaît entrer les informations suivantes:',
    'For example: QIIXJXNUI or QIIXJXNUI#1' => 'Par exemple: QIIXJXNUI ou QIIXJXNUI # 1',
    'Guest Tracking' => 'Suivi des clients',
    'Transform your guest account into a customer account and enjoy:' => 'Transformez votre compte invité dans un compte client et profitez de:',
    'Personalized and secure access' => 'accès personnalisé et sécurisé',
    'Fast and easy checkout' => 'Achat rapide et facile',
    'Easier merchandise return' => 'Retour facile de marchandise',
    'Order history' => 'Historique des commandes',
    'Here are the orders you\'ve placed since your account was created.' => 'Voici les commandes que vous avez placé depuis votre compte a été créé.',
    'Details' => 'Détails',
    'Your personal information' => 'Vos informations personnelles',
    'Vouchers' => 'Pièces justificatives',
    'Credit slips' => 'bordereaux de crédit',
    'Addresses' => 'adresses',
    'Add first address' => 'Ajouter première adresse',
    'Information' => 'Information',
    'Order history and details' => 'Historique des commandes et les détails',
    'Merchandise returns' => 'retour de marchandise',
    'Order details' => 'Détails de la commande',
    'Order Reference %reference% - placed on %date%' => 'Référence de commande %reference% - mise en %date%',
    'Download your invoice as a PDF file.' => 'Téléchargez votre facture en fichier PDF.',
    'You have given permission to receive your order in recycled packaging.' => 'Vous avez donné la permission de recevoir votre commande dans un emballage recyclé.',
    'You have requested gift wrapping for this order.' => 'Vous avez demandé l\'emballage cadeau pour cette commande.',
    'Message' => 'Message',
    'Follow your order\'s status step-by-step' => 'Suivez l\'état de votre commande étape par étape',
    ...
    'Return' => 'Revenir',
    'Package status' => 'Suivi du colis',
    'Returns form' => 'Retours forment',
    'Return details' => 'Informations sur le retour',
    '%number% on %date%' => '%number% en %date%',
    'We have logged your return request.' => 'Nous avons enregistré votre demande de retour.',
    'Your package must be returned to us within %number% days of receiving your order.' => 'Votre colis doit nous être retourné en %number% jours de réception de votre commande.',
    'The current status of your merchandise return is: [1] %status% [/1]' => 'L\'état actuel de votre retour de marchandises est: [1] %status% [/1]',
    'List of items to be returned:' => 'Liste des articles à retourner:',
    'Reminder' => 'Rappel',
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toute la marchandise doit être retourné dans son emballage d\'origine et dans son état d\'origine.',
    'Please print out the [1]returns form[/1] and include it with your package.' => 'Veuillez imprimer le [1]returns form[/1] et l\'inclure dans votre colis.',
    'Please check the [1]returns form[/1] for the correct address.' => 'Veuillez vérifier le [1]returns form[/1] pour l\'adresse correcte.',
    'When we receive your package, we will notify you by email. We will then begin processing order reimbursement.' => 'Lorsque nous recevons votre colis, nous vous informerons par e-mail. Nous allons ensuite commencer le remboursement du traitement des commandes.',
    'Please let us know if you have any questions.' => 'S\'il vous plaît laissez-nous savoir si vous avez des questions.',
    'If the conditions of return listed above are not respected, we reserve the right to refuse your package and/or reimbursement.' => 'Si les conditions de retour énumérées ci-dessus ne sont pas respectées, nous nous réservons le droit de refuser votre colis et / ou le remboursement.',
    'Credit slips you have received after canceled orders.' => 'bordereaux de crédit que vous avez reçu des commandes après annulées.',
    'Credit slip' => 'note de crédit',
    'View credit slip' => 'Voir le bulletin de crédit',
    'Please enter the email address you used to register. You will receive a temporary link to reset your password.' => 'S\'il vous plaît entrez l\'adresse e-mail que vous avez utilisé pour vous inscrire. Vous recevrez un lien temporaire pour réinitialiser votre mot de passe.',
    'Forgot your password?' => 'Mot de passe oublié?',
  ...
  array (
    ...
    'New products' => 'Nouveaux produits',
    'All new products' => 'Tous les nouveaux produits',
    '1 person is currently watching this product.' => '1 personne est en train de regarder ce produit.',
    '%nb_people% people are currently watching this product.' => '%nb_people% des gens regardent actuellement ce produit.',
    'Last time this product was bought: %date_last_order%' => 'La dernière fois que ce produit a été acheté: %date_last_order%',
    'Last time this product was added to a cart: %date_last_cart%' => 'La dernière fois que ce produit a été ajouté à un panier: %date_last_cart%',
    'No RSS feed added' => 'Aucun flux RSS ajouté',
    'Search our catalog' => 'Rechercher notre catalogue',
    'Search' => 'Rechercher',
    'On sale' => 'En promo',
    ...
    'Showing %from%-%to% of %total% item(s)' => 'Montrer%from%-%to% de %total% d\'élément (s)',
    '%1$s: ' => '%1$s:',
    'Price' => 'Prix',
    ...
    'Condition' => 'Condition',
    'Volume discounts' => 'réductions de volume',
    ...
    '%price% tax excl.' => '%price% TVA excl.',
    'Instead of %price%' => 'Au lieu de %price%',
    'Including %amount% for ecotax' => 'Y compris %amount% pour l\'écotaxe',
    '(not impacted by the discount)' => '(non compris dans la réduction)',
    '(%unit_price%)' => '(%unit_price%)',
    'There are %product_count% products.' => 'Il existe %product_count% produits.',
    'There is 1 product.' => 'Il y a 1 produit.',
    'List of products by brand %brand_name%' => 'Liste des produits de la marque %brand_name%',
    'List of products by supplier %s' => 'Liste des produits par fournisseur %s',
    ...
    'Product customization' => 'Personnalisation de produit',
    'Reviews' => 'Commentaires',
    'List of products by brand %s' => 'Liste des produits par marque %s',
  ),
  ...
  array (
    ...
    'Select reference' => 'sélection référence',
    'optional' => 'optionnel',
    'How can we help?' => 'Comment pouvons nous aider?',
    '250 char. max' => '250 ombles. max',
    'Don\'t forget to save your customization to be able to add to cart' => 'Ne pas oublier de sauvegarder votre personnalisation pour pouvoir ajouter au panier',
  ...
  array (
    ...
    'Subject' => 'Assujettir',
    'Order reference' => 'Référence de l\'achat',
    'Attachment' => 'Attachement',
    'Your email address' => 'Votre adresse email',
    '-- day --' => '-- journée --',
    '-- month --' => '- mois -',
  ...
  array (
    ...
    'Add a new theme' => 'Importer un thème',
    ...
    'min' => 'moi',
    'sec' => 'seconde',
    'No products at this time.' => 'Aucun produit pour le moment.',
    ...
    'View all in instagram' => 'Afficher tout dans instagram',
    'View All' => 'Voir tout
',
  ),
...
Cordialement,',
  ...
  array (
    ...
    'Save Customization' => 'Personnalisation Enregistrer',
    'Filter' => 'Filtre',
    ...
    'Reorder' => 'Réorganiser',
    'Print out' => 'Imprimer',
    'Send reset link' => 'Envoyer le lien reset',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Awaiting wire payment' => 'En attente de paiement',
  ...
  array (
    ...
    'Product successfully added to your shopping cart' => 'Produit a été ajouté à votre panier',
    'Quantity:' => 'Quantité:',
    'There are %products_count% items in your cart.' => 'Il existe %products_count% items dans votre panier.',
    'There is %product_count% item in your cart.' => 'Il existe %product_count% item dans votre panier.',
    'Total products:' => 'Produits totaux:',
    'Total shipping:' => 'Expédition totale:',
    'Total:' => 'Total:',
    'Cart' => 'Chariot',
    'The minimum purchase order quantity for the product is %quantity%.' => 'La quantité minimale de commande d\'achat pour le produit est  %quantity%.',
    'Use this address for invoice too' => 'Utilisez cette adresse pour la facture trop',
    'Gift' => 'Cadeau',
    'There are no more items in your cart' => 'Il n\'y a pas plus d\'articles dans votre panier',
    'Promo code' => 'Code promo',
    'Have a promo code?' => 'Avez vous un code de réduction?',
    'Create an account' => 'Créer un compte',
    '(optional)' => '(optionnel)',
    'And save time on your next order!' => 'Et gagner du temps sur votre prochaine commande!',
    'Order items' => 'Items commandés',
    '%product_count% item in your cart' => '%product_count% item dans votre panier',
    '%products_count% items in your cart' => '%products_count% items dans votre panier',
    'Shipping Method' => 'Méthode d\'envoi',
    'Addresses' => 'adresses',
    'Please check your order before payment' => 'S\'il vous plaît vérifier votre commande avant paiement',
    'Your Delivery Address' => 'Votre adresse de livraison',
    'Shipping Address' => 'Adresse de livraison',
    'The selected address will be used as your personal address (for invoice).' => 'L\'adresse sélectionnée sera utilisée comme votre adresse personnelle (pour la facture).',
    'Billing address differs from shipping address' => 'Adresse de facturation est différente de l\'adresse de livraison',
    'Your Invoice Address' => 'Votre adresse de facturation',
    'The selected address will be used both as your personal address (for invoice) and as your delivery address.' => 'L\'adresse sélectionnée sera utilisée à la fois comme votre adresse personnelle (pour la facture) et que votre adresse de livraison.',
    'Transaction amount has been correctly updated' => 'Le montant de la transaction a correctement été mis à jour',
    'By confirming the order, you certify that you have read and agree with all of the conditions below:' => 'En confirmant l\'ordre, vous certifiez que vous avez lu et accepté toutes les conditions ci-dessous:',
    'Selected' => 'Choisi',
    'Unfortunately, there are no payment method available.' => 'Malheureusement, il n\'y a pas moyen de paiement disponible.',
    'Please make sure you\'ve chosen a [1]payment method[/1] and accepted the [2]terms and conditions[/2].' => 'Assurez-vous d\'avoir choisi une [1]payment method[/1 et a accepté les [2]terms and conditions[/2].',
    'No payment needed for this order' => 'Aucun paiement nécessaire pour cette commande',
    'Order with an obligation to pay' => 'Commander avec une obligation de payer',
    'If you sign out now, your cart will be emptied.' => 'Si vous vous déconnectez maintenant, votre panier sera vidé.',
    'Order as a guest' => 'Commande en tant qu\'invité',
    'I would like to receive my order in recycled packaging.' => 'Je souhaite recevoir ma commande dans un emballage recyclé.',
    'If you\'d like, you can add a note to the gift:' => 'Si vous le souhaitez, vous pouvez ajouter une note au don:',
    'Unfortunately, there are no carriers available for your delivery address.' => 'Malheureusement, il n\'y a pas des transporteurs disponibles pour votre adresse de livraison.',
    'If you would like to add a comment about your order, please write it in the field below.' => 'Si vous voulez nous laisser un message à propos de votre commande, merci de bien vouloir le renseigner dans le champ ci-contre',
    'Shopping Cart' => 'Chariot',
    'Your order is confirmed' => 'Votre commande est confirmée',
    'An email has been sent to your mail address %email%.' => 'Un courriel a été envoyé à votre adresse courriel %email%.',
    'You can also [1]download your invoice[/1]' => 'Vous pouvez également [1]download your invoice[/1]',
    'Order details' => 'Détails de la commande',
    'Save time on your next order, sign up now' => 'Gagnez du temps sur votre prochaine commande, vous inscrire maintenant',
  ...
  array (
    ...
    'Adjust your shipping costs by filling in the product dimensions.' => 'Ajustez vos frais de livraison en renseignant les dimensions du colis.',
    'Leave empty to disable.' => 'Laisser vide pour désactiver.',
